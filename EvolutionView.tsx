  ...
  return (
    <div className="flex flex-col items-center justify-center flex-1 space-y-12">
      ...
      <div className="w-full space-y-4">
        <button 
          onClick={onLogin}
          className="w-full py-4 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center space-x-3 hover:bg-white/10 transition-all active:scale-95"
        >
        ...
        <div className="pt-8 flex justify-center">
          <button 
            ...
            className="text-[9px] uppercase tracking-[0.3em] text-white/20 hover:text-sage transition-colors"
          >
            Acesso Clínico
          </button>
        </div>
      ...
      <p className="text-[10px] text-center text-white/40 max-w-[200px] leading-relaxed">
